    ...
    for mod_name in models_to_try:
        try:
            ...
            prompt = (
                ...
                "2. Check if this image appears to be created/generated by AI (e.g. Midjourney, DALL-E, Stable Diffusion, ChatGPT, Gemini, Firefly) or manipulated/edited (e.g. synthetic textures, distorted hands/text, AI artifacts).\n\n"
                "CRITICAL REQUIREMENT: 'ai_reason' MUST BE WRITTEN ENTIRELY IN CLEAR, DETAILED THAI LANGUAGE (ภาษาไทย) explaining the specific visual signs of AI generation or explaining why it appears to be a real photo/screenshot.\n\n"
                "Return output in strict valid JSON format:\n"
                "{\n"
                '  "text": "extracted text verbatim",\n'
                '  "is_ai": true/false,\n'
                '  "ai_reason": "คำอธิบายอย่างละเอียดเป็นภาษาไทยเกี่ยวกับร่องรอยพิกเซล หรือองค์ประกอบของภาพสังเคราะห์ AI หรือภาพถ่ายกล้อง",\n'
